...
class OpenAIEmbeddingFunction:
    ...
    def __call__(self, input: List[str]) -> List[List[float]]:
        return embed_texts(input, self.model_name)
...
def main():
    ...
    try:
        ...
        print(f"Error resolving fine-tuned model: {e}")
        print("Using default embedding model: text-embedding-3-small")
    ...
    try:
        ...
        print("No documents found in collection or embedding error.")
        context_block = "No relevant information available."
